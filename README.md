...
|------------|---------|---------|
| Java       | 10+     | Core language: Used to write all game logic, build classes (Ball, Paddle, Brick), manage game logic (GameManager.java) and states, define data structures (List<Brick>, Map<Integer, BrickFactory>). |
