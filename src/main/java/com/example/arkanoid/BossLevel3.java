...
//*******************************************************************************************************************
 // if (attackTimer >= currentAttackCycle &&
      //  (currentState == BossLevel3.BossState.IDLE_PHASE1 || currentState == BossLevel3.BossState.IDLE_PHASE2)) {

//attackTimer = 0.0;
//currentFrame = 0;
//currentState = isPhase1 ? BossLevel3.BossState.SPAWNING_PHASE1 : BossLevel3.BossState.SPAWNING_PHASE2;
//itemDropped = false;
//frameTime = -frameDuration / 2; // 🔥 Delay nửa frame trước khi đếm frame
  //      return; // 🔥 Ngăn không xử lý logic frame ngay trong frame này
